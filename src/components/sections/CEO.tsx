    ...
    <section className="py-24 bg-[#0E1A2B] relative overflow-hidden">
      ...
      <div className="max-w-[1180px] mx-auto px-7">
        <motion.div
          ...
          className="relative rounded-3xl border border-white/10 bg-[#15233A]/70 backdrop-blur-sm overflow-hidden"
        >
          {/* Top cyan accent */}
          ...
          <div className="grid md:grid-cols-2 gap-0">
            {/* Left — CEO info */}
            <div className="flex flex-col gap-8 md:border-r md:border-white/8 p-10 md:p-12">
              {/* Avatar + name */}
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="font-black text-xl text-white">Isuru Malaka</h3>
                  <p className="text-[#18b2de] text-sm font-semibold mt-0.5">Chief Executive Officer</p>
                  <p className="text-[#7A8FA6] text-xs font-mono mt-0.5">DigiHack · Adzcept Group</p>
                </div>
              </div>

              {/* Credentials */}
              <div className="space-y-3">
                <p className="text-[#7A8FA6] text-[10px] uppercase tracking-widest font-mono">Credentials</p>
                {[
                  ...
                  <div key={c} className="flex items-start gap-2.5">
                    ...
                    <span className="text-[#9aa3b2] text-sm">{c}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center gap-6 p-10 md:p-12">
              ...
              <blockquote className="space-y-4">
                <p className="text-white text-[17px] leading-[1.7] font-light">
                ...
                <p className="text-[#9aa3b2] text-[14.5px] leading-[1.7]">
              ...
              <div className="pt-3 border-t border-white/10">
                <p className="text-white font-bold">Isuru Malaka</p>
                <p className="text-[#7A8FA6] text-sm font-mono">CEO, DigiHack · Sri Lanka & United States</p>
              </div>
            </div>
          </div>
        </motion.div>
